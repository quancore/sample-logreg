This repo contains an example machine learning application using Logistic regression. The task and dataset: https://www.kaggle.com/uciml/pima-indians-diabetes-database <br>
**Properties:**
